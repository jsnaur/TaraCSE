...
type UserStatus = "free" | "pending" | "premium";
type ActionType = "upgrade" | "revoke";
...
const INITIAL_USERS: User[] = [
  {
    id: "u1",
    name: "Maria Santos",
    email: "maria.santos92@gmail.com",
    gcashRef: "8012345678912",
  ...
  },
  {
    id: "u2",
    name: "Juan Dela Cruz",
    email: "jdelacruz@yahoo.com",
    gcashRef: "8019876543210",
    dateRegistered: "2025-06-28",
    status: "pending",
    avatarInitials: "JD",
  ...
  },
  {
    id: "u3",
    name: "Mark Reyes",
    email: "mark.reyes.ph@gmail.com",
    gcashRef: "8031122334455",
  ...
  },
  {
    id: "u4",
    name: "Ana Gonzales",
    email: "anagonzales_baguio@gmail.com",
    gcashRef: null,
  ...
  },
  {
    id: "u5",
    name: "Carlo Mendoza",
    email: "carlo.mendoza2024@gmail.com",
    gcashRef: "8056677889900",
    dateRegistered: "2025-07-02",
    status: "pending",
    avatarInitials: "CM",
  ...
  },
  {
    id: "u6",
    name: "Liza Bautista",
    email: "lizabautista_cebu@yahoo.com",
    gcashRef: "8041234000321",
    dateRegistered: "2025-05-30",
    status: "premium",
    avatarInitials: "LB",
  ...
  },
  {
    ...
    email: "ryanv.ph@gmail.com",
    gcashRef: null,
    dateRegistered: "2025-07-03",
    status: "free",
    avatarInitials: "RV",
  ...
  },
  {
    id: "u8",
    name: "Jasmine Ramos",
    email: "jasmine.ramos.davao@gmail.com",
    gcashRef: "8079988776655",
  ...
  },
  {
    id: "u9",
    name: "Paolo Torres",
    email: "paolotorres1997@gmail.com",
    gcashRef: "8023456789012",
    dateRegistered: "2025-05-18",
    status: "premium",
    avatarInitials: "PT",
...
export default function AdminVerificationPage() {
  ...
  function triggerAction(userId: string, userName: string, type: ActionType) {
    setPendingAction({ userId, userName, type });
    setDialogOpen(true);
  }

  async function handleUpgrade(userId: string) {
    // Replace this mock with a real Supabase query when you wire up the database.
    // Example Supabase update syntax:
  ...
  function handleConfirm() {
    ...
    const { userId, userName, type } = pendingAction;
                          ...
                          <TableCell className="py-4 pr-6">
                            <div className="flex items-center justify-end gap-2">
                              {user.status !== "premium" && (
                                <Button
                                  size="sm"
                                  onClick={() => triggerAction(user.id, user.name, "upgrade")}
                              ...
                              {user.status === "premium" && (
                                <Button
                                  size="sm"
                                  variant="destructive"
                                  onClick={() => triggerAction(user.id, user.name, "revoke")}
